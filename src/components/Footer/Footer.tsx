...
import { icon_footer_i, logo_luxaria } from '../../data/img/img-data';
                ...
                <div className="footer-section-1">
                    <div className="footer-1-1">
                        ...
                        <div className='social-web'>
                            ...
                            <img onClick={() => redirectToExternalLink('https://www.instagram.com/luxaria.eventos?igsh=azBwMHplcGtkcm5q&utm_source=qr')} src={icon_footer_i.url} alt={icon_footer_i.alt} />
